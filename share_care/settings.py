"""
Django settings for share_care project.
...
print("DJANGO TEMPLATE BASE PATH IS:", os.path.join(BASE_DIR, 'templates'))
...
SECRET_KEY = 'django-insecure-1#c1x2x1quf2^=wi^(wiov##(4=vb16h%@rdik*bzl+)io3q(0'
